...
export class IoniconPeopleCircleComponent{}

@NgModule({
    declarations: [IoniconPeopleCircleComponent],
    imports: [
        CommonModule
    ],
    exports: [
        IoniconPeopleCircleComponent
    ],
})
export class IoniconPeopleCircleModule {
}
