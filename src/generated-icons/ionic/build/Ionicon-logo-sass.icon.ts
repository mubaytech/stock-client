...
export class IoniconLogoSassComponent{}

@NgModule({
    declarations: [IoniconLogoSassComponent],
    imports: [
        CommonModule
    ],
    exports: [
        IoniconLogoSassComponent
    ],
})
export class IoniconLogoSassModule {
}
