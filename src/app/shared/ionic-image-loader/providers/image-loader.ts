...
import {File, FileEntry, FileOriginal} from '@ionic-native/file';
...
export class ImageLoader {
    ...
    private cacheIndex: Array<IndexItem> = [];
    ...
    constructor(
        ...
        this.file = (file as unknown as FileOriginal);
    ...
    private get isDevServer(): boolean {
        return (window as any).IonicDevServer !== undefined;
    }
     ...
     */
    private throwError(...args: Array<any>): void {
     ...
     * @param {any[]} args Error message
     */
    private throwWarning(...args: Array<any>): void {
        if (this.config.debugMode) {
    ...
    private createCacheDirectory(replace: boolean = false): Promise<any> {
        ...
        let tempDirectoryPromise: Promise<any>;
