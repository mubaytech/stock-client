...
export class MaterialTableVirtualScroll implements VirtualScrollStrategy {
  scrolledIndexChange: Observable<number>;
  private dataLength = 0;
  private readonly indexChange = new Subject<number>();
  private viewport: CdkVirtualScrollViewport;
  private offset = 0;
  private offsetChange$: BehaviorSubject<number> = new BehaviorSubject(0);
  ...
  offsetChange = this.offsetChange$.asObservable().pipe(distinctUntilChanged());
}
