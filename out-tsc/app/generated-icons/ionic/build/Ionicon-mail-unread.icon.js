...
], IoniconMailUnreadComponent);
export { IoniconMailUnreadComponent };
let IoniconMailUnreadModule = class IoniconMailUnreadModule {
};
IoniconMailUnreadModule = __decorate([
    NgModule({
        declarations: [IoniconMailUnreadComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconMailUnreadModule);
export { IoniconMailUnreadModule };
//# sourceMappingURL=Ionicon-mail-unread.icon.js.map