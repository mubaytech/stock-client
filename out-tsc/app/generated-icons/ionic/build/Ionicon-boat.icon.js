...
], IoniconBoatComponent);
export { IoniconBoatComponent };
let IoniconBoatModule = class IoniconBoatModule {
};
IoniconBoatModule = __decorate([
    NgModule({
        declarations: [IoniconBoatComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconBoatModule };
//# sourceMappingURL=Ionicon-boat.icon.js.map