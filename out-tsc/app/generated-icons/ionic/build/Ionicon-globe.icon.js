...
], IoniconGlobeComponent);
export { IoniconGlobeComponent };
let IoniconGlobeModule = class IoniconGlobeModule {
};
IoniconGlobeModule = __decorate([
    NgModule({
        declarations: [IoniconGlobeComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconGlobeModule };
//# sourceMappingURL=Ionicon-globe.icon.js.map