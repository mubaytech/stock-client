...
], IoniconLogoElectronComponent);
export { IoniconLogoElectronComponent };
let IoniconLogoElectronModule = class IoniconLogoElectronModule {
};
IoniconLogoElectronModule = __decorate([
    NgModule({
        declarations: [IoniconLogoElectronComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconLogoElectronModule);
export { IoniconLogoElectronModule };
//# sourceMappingURL=Ionicon-logo-electron.icon.js.map