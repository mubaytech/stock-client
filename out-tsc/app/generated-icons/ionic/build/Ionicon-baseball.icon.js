...
], IoniconBaseballComponent);
export { IoniconBaseballComponent };
let IoniconBaseballModule = class IoniconBaseballModule {
};
IoniconBaseballModule = __decorate([
    NgModule({
        declarations: [IoniconBaseballComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconBaseballModule);
export { IoniconBaseballModule };
//# sourceMappingURL=Ionicon-baseball.icon.js.map