...
], IoniconSnowComponent);
export { IoniconSnowComponent };
let IoniconSnowModule = class IoniconSnowModule {
};
IoniconSnowModule = __decorate([
    NgModule({
        declarations: [IoniconSnowComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconSnowModule };
//# sourceMappingURL=Ionicon-snow.icon.js.map