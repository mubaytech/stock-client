...
], IoniconFootballComponent);
export { IoniconFootballComponent };
let IoniconFootballModule = class IoniconFootballModule {
};
IoniconFootballModule = __decorate([
    NgModule({
        declarations: [IoniconFootballComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconFootballModule);
export { IoniconFootballModule };
//# sourceMappingURL=Ionicon-football.icon.js.map