...
], IoniconLogoNoSmokingComponent);
export { IoniconLogoNoSmokingComponent };
let IoniconLogoNoSmokingModule = class IoniconLogoNoSmokingModule {
};
IoniconLogoNoSmokingModule = __decorate([
    NgModule({
        declarations: [IoniconLogoNoSmokingComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconLogoNoSmokingModule);
export { IoniconLogoNoSmokingModule };
//# sourceMappingURL=Ionicon-logo-no-smoking.icon.js.map