...
], IoniconBasketballComponent);
export { IoniconBasketballComponent };
let IoniconBasketballModule = class IoniconBasketballModule {
};
IoniconBasketballModule = __decorate([
    NgModule({
        declarations: [IoniconBasketballComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconBasketballModule);
export { IoniconBasketballModule };
//# sourceMappingURL=Ionicon-basketball.icon.js.map