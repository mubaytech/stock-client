...
let IoniconPawSharpComponent = class IoniconPawSharpComponent {
};
IoniconPawSharpComponent = __decorate([
    Component({
...
export { IoniconPawSharpComponent };
let IoniconPawSharpModule = class IoniconPawSharpModule {
};
IoniconPawSharpModule = __decorate([
    NgModule({
...
], IoniconPawSharpModule);
export { IoniconPawSharpModule };
//# sourceMappingURL=Ionicon-paw-sharp.icon.js.map