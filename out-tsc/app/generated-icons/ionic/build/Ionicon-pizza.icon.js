...
], IoniconPizzaComponent);
export { IoniconPizzaComponent };
let IoniconPizzaModule = class IoniconPizzaModule {
};
IoniconPizzaModule = __decorate([
    NgModule({
        declarations: [IoniconPizzaComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconPizzaModule };
//# sourceMappingURL=Ionicon-pizza.icon.js.map