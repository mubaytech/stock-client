...
], IoniconSkullComponent);
export { IoniconSkullComponent };
let IoniconSkullModule = class IoniconSkullModule {
};
IoniconSkullModule = __decorate([
    NgModule({
        declarations: [IoniconSkullComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconSkullModule };
//# sourceMappingURL=Ionicon-skull.icon.js.map