...
let IoniconHeadsetSharpComponent = class IoniconHeadsetSharpComponent {
};
IoniconHeadsetSharpComponent = __decorate([
    Component({
...
export { IoniconHeadsetSharpComponent };
let IoniconHeadsetSharpModule = class IoniconHeadsetSharpModule {
};
IoniconHeadsetSharpModule = __decorate([
    NgModule({
...
], IoniconHeadsetSharpModule);
export { IoniconHeadsetSharpModule };
//# sourceMappingURL=Ionicon-headset-sharp.icon.js.map