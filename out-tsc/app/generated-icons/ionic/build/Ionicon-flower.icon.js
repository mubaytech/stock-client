...
], IoniconFlowerComponent);
export { IoniconFlowerComponent };
let IoniconFlowerModule = class IoniconFlowerModule {
};
IoniconFlowerModule = __decorate([
    NgModule({
        declarations: [IoniconFlowerComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconFlowerModule };
//# sourceMappingURL=Ionicon-flower.icon.js.map