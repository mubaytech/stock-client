...
], IoniconTelescopeComponent);
export { IoniconTelescopeComponent };
let IoniconTelescopeModule = class IoniconTelescopeModule {
};
IoniconTelescopeModule = __decorate([
    NgModule({
        declarations: [IoniconTelescopeComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconTelescopeModule);
export { IoniconTelescopeModule };
//# sourceMappingURL=Ionicon-telescope.icon.js.map