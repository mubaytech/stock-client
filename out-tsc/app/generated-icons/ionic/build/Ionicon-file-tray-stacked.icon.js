...
let IoniconFileTrayStackedComponent = class IoniconFileTrayStackedComponent {
};
IoniconFileTrayStackedComponent = __decorate([
    Component({
...
export { IoniconFileTrayStackedComponent };
let IoniconFileTrayStackedModule = class IoniconFileTrayStackedModule {
};
IoniconFileTrayStackedModule = __decorate([
    NgModule({
...
], IoniconFileTrayStackedModule);
export { IoniconFileTrayStackedModule };
//# sourceMappingURL=Ionicon-file-tray-stacked.icon.js.map