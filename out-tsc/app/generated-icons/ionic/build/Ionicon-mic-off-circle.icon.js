...
], IoniconMicOffCircleComponent);
export { IoniconMicOffCircleComponent };
let IoniconMicOffCircleModule = class IoniconMicOffCircleModule {
};
IoniconMicOffCircleModule = __decorate([
    NgModule({
        declarations: [IoniconMicOffCircleComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconMicOffCircleModule);
export { IoniconMicOffCircleModule };
//# sourceMappingURL=Ionicon-mic-off-circle.icon.js.map