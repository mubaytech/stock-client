...
let IoniconLogoBitbucketComponent = class IoniconLogoBitbucketComponent {
};
IoniconLogoBitbucketComponent = __decorate([
    Component({
...
export { IoniconLogoBitbucketComponent };
let IoniconLogoBitbucketModule = class IoniconLogoBitbucketModule {
};
IoniconLogoBitbucketModule = __decorate([
    NgModule({
...
], IoniconLogoBitbucketModule);
export { IoniconLogoBitbucketModule };
//# sourceMappingURL=Ionicon-logo-bitbucket.icon.js.map