...
let IoniconFlameSharpComponent = class IoniconFlameSharpComponent {
};
IoniconFlameSharpComponent = __decorate([
    Component({
...
export { IoniconFlameSharpComponent };
let IoniconFlameSharpModule = class IoniconFlameSharpModule {
};
IoniconFlameSharpModule = __decorate([
    NgModule({
...
], IoniconFlameSharpModule);
export { IoniconFlameSharpModule };
//# sourceMappingURL=Ionicon-flame-sharp.icon.js.map