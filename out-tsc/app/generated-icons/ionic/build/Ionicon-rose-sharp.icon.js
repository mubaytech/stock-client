...
], IoniconRoseSharpComponent);
export { IoniconRoseSharpComponent };
let IoniconRoseSharpModule = class IoniconRoseSharpModule {
};
IoniconRoseSharpModule = __decorate([
    NgModule({
        declarations: [IoniconRoseSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconRoseSharpModule);
export { IoniconRoseSharpModule };
//# sourceMappingURL=Ionicon-rose-sharp.icon.js.map