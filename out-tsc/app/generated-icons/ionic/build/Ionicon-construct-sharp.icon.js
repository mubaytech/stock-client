...
], IoniconConstructSharpComponent);
export { IoniconConstructSharpComponent };
let IoniconConstructSharpModule = class IoniconConstructSharpModule {
};
IoniconConstructSharpModule = __decorate([
    NgModule({
        declarations: [IoniconConstructSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconConstructSharpModule);
export { IoniconConstructSharpModule };
//# sourceMappingURL=Ionicon-construct-sharp.icon.js.map