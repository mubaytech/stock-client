...
], IoniconPlanetSharpComponent);
export { IoniconPlanetSharpComponent };
let IoniconPlanetSharpModule = class IoniconPlanetSharpModule {
};
IoniconPlanetSharpModule = __decorate([
    NgModule({
        declarations: [IoniconPlanetSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconPlanetSharpModule);
export { IoniconPlanetSharpModule };
//# sourceMappingURL=Ionicon-planet-sharp.icon.js.map