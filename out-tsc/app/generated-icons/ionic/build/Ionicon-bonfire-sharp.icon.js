...
], IoniconBonfireSharpComponent);
export { IoniconBonfireSharpComponent };
let IoniconBonfireSharpModule = class IoniconBonfireSharpModule {
};
IoniconBonfireSharpModule = __decorate([
    NgModule({
        declarations: [IoniconBonfireSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconBonfireSharpModule);
export { IoniconBonfireSharpModule };
//# sourceMappingURL=Ionicon-bonfire-sharp.icon.js.map