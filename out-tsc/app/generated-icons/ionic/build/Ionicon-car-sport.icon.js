...
], IoniconCarSportComponent);
export { IoniconCarSportComponent };
let IoniconCarSportModule = class IoniconCarSportModule {
};
IoniconCarSportModule = __decorate([
    NgModule({
        declarations: [IoniconCarSportComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconCarSportModule);
export { IoniconCarSportModule };
//# sourceMappingURL=Ionicon-car-sport.icon.js.map