...
], IoniconCogSharpComponent);
export { IoniconCogSharpComponent };
let IoniconCogSharpModule = class IoniconCogSharpModule {
};
IoniconCogSharpModule = __decorate([
    NgModule({
        declarations: [IoniconCogSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconCogSharpModule);
export { IoniconCogSharpModule };
//# sourceMappingURL=Ionicon-cog-sharp.icon.js.map