...
], IoniconFootstepsComponent);
export { IoniconFootstepsComponent };
let IoniconFootstepsModule = class IoniconFootstepsModule {
};
IoniconFootstepsModule = __decorate([
    NgModule({
        declarations: [IoniconFootstepsComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconFootstepsModule);
export { IoniconFootstepsModule };
//# sourceMappingURL=Ionicon-footsteps.icon.js.map