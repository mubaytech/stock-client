...
], IoniconServerSharpComponent);
export { IoniconServerSharpComponent };
let IoniconServerSharpModule = class IoniconServerSharpModule {
};
IoniconServerSharpModule = __decorate([
    NgModule({
        declarations: [IoniconServerSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconServerSharpModule);
export { IoniconServerSharpModule };
//# sourceMappingURL=Ionicon-server-sharp.icon.js.map