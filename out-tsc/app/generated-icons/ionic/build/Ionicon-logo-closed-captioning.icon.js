...
], IoniconLogoClosedCaptioningComponent);
export { IoniconLogoClosedCaptioningComponent };
let IoniconLogoClosedCaptioningModule = class IoniconLogoClosedCaptioningModule {
};
IoniconLogoClosedCaptioningModule = __decorate([
    NgModule({
        declarations: [IoniconLogoClosedCaptioningComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconLogoClosedCaptioningModule);
export { IoniconLogoClosedCaptioningModule };
//# sourceMappingURL=Ionicon-logo-closed-captioning.icon.js.map