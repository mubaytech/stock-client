...
], IoniconThumbsDownComponent);
export { IoniconThumbsDownComponent };
let IoniconThumbsDownModule = class IoniconThumbsDownModule {
};
IoniconThumbsDownModule = __decorate([
    NgModule({
        declarations: [IoniconThumbsDownComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconThumbsDownModule);
export { IoniconThumbsDownModule };
//# sourceMappingURL=Ionicon-thumbs-down.icon.js.map