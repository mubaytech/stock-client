...
let IoniconTerminalSharpComponent = class IoniconTerminalSharpComponent {
};
IoniconTerminalSharpComponent = __decorate([
    Component({
...
export { IoniconTerminalSharpComponent };
let IoniconTerminalSharpModule = class IoniconTerminalSharpModule {
};
IoniconTerminalSharpModule = __decorate([
    NgModule({
...
], IoniconTerminalSharpModule);
export { IoniconTerminalSharpModule };
//# sourceMappingURL=Ionicon-terminal-sharp.icon.js.map