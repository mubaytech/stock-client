...
], IoniconRoseComponent);
export { IoniconRoseComponent };
let IoniconRoseModule = class IoniconRoseModule {
};
IoniconRoseModule = __decorate([
    NgModule({
        declarations: [IoniconRoseComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconRoseModule };
//# sourceMappingURL=Ionicon-rose.icon.js.map