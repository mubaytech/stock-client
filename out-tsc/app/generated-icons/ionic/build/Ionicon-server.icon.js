...
], IoniconServerComponent);
export { IoniconServerComponent };
let IoniconServerModule = class IoniconServerModule {
};
IoniconServerModule = __decorate([
    NgModule({
        declarations: [IoniconServerComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconServerModule };
//# sourceMappingURL=Ionicon-server.icon.js.map