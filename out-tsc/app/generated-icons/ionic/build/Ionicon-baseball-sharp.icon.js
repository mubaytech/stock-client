...
], IoniconBaseballSharpComponent);
export { IoniconBaseballSharpComponent };
let IoniconBaseballSharpModule = class IoniconBaseballSharpModule {
};
IoniconBaseballSharpModule = __decorate([
    NgModule({
        declarations: [IoniconBaseballSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconBaseballSharpModule);
export { IoniconBaseballSharpModule };
//# sourceMappingURL=Ionicon-baseball-sharp.icon.js.map