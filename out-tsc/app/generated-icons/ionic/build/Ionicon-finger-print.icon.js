...
], IoniconFingerPrintComponent);
export { IoniconFingerPrintComponent };
let IoniconFingerPrintModule = class IoniconFingerPrintModule {
};
IoniconFingerPrintModule = __decorate([
    NgModule({
        declarations: [IoniconFingerPrintComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconFingerPrintModule);
export { IoniconFingerPrintModule };
//# sourceMappingURL=Ionicon-finger-print.icon.js.map