...
], IoniconReceiptComponent);
export { IoniconReceiptComponent };
let IoniconReceiptModule = class IoniconReceiptModule {
};
IoniconReceiptModule = __decorate([
    NgModule({
        declarations: [IoniconReceiptComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconReceiptModule);
export { IoniconReceiptModule };
//# sourceMappingURL=Ionicon-receipt.icon.js.map