...
let IoniconMedalComponent = class IoniconMedalComponent {
};
IoniconMedalComponent = __decorate([
    Component({
...
export { IoniconMedalComponent };
let IoniconMedalModule = class IoniconMedalModule {
};
IoniconMedalModule = __decorate([
    NgModule({
...
export { IoniconMedalModule };
//# sourceMappingURL=Ionicon-medal.icon.js.map