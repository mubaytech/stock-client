...
], IoniconBeerComponent);
export { IoniconBeerComponent };
let IoniconBeerModule = class IoniconBeerModule {
};
IoniconBeerModule = __decorate([
    NgModule({
        declarations: [IoniconBeerComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconBeerModule };
//# sourceMappingURL=Ionicon-beer.icon.js.map