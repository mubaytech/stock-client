...
let IoniconPhoneLandscapeComponent = class IoniconPhoneLandscapeComponent {
};
IoniconPhoneLandscapeComponent = __decorate([
    Component({
...
export { IoniconPhoneLandscapeComponent };
let IoniconPhoneLandscapeModule = class IoniconPhoneLandscapeModule {
};
IoniconPhoneLandscapeModule = __decorate([
    NgModule({
...
], IoniconPhoneLandscapeModule);
export { IoniconPhoneLandscapeModule };
//# sourceMappingURL=Ionicon-phone-landscape.icon.js.map