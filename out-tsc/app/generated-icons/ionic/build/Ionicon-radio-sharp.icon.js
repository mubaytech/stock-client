...
let IoniconRadioSharpComponent = class IoniconRadioSharpComponent {
};
IoniconRadioSharpComponent = __decorate([
    Component({
...
export { IoniconRadioSharpComponent };
let IoniconRadioSharpModule = class IoniconRadioSharpModule {
};
IoniconRadioSharpModule = __decorate([
    NgModule({
...
], IoniconRadioSharpModule);
export { IoniconRadioSharpModule };
//# sourceMappingURL=Ionicon-radio-sharp.icon.js.map