...
], IoniconCloudyNightComponent);
export { IoniconCloudyNightComponent };
let IoniconCloudyNightModule = class IoniconCloudyNightModule {
};
IoniconCloudyNightModule = __decorate([
    NgModule({
        declarations: [IoniconCloudyNightComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconCloudyNightModule);
export { IoniconCloudyNightModule };
//# sourceMappingURL=Ionicon-cloudy-night.icon.js.map