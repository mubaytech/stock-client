...
], IoniconPartlySunnyComponent);
export { IoniconPartlySunnyComponent };
let IoniconPartlySunnyModule = class IoniconPartlySunnyModule {
};
IoniconPartlySunnyModule = __decorate([
    NgModule({
        declarations: [IoniconPartlySunnyComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconPartlySunnyModule);
export { IoniconPartlySunnyModule };
//# sourceMappingURL=Ionicon-partly-sunny.icon.js.map