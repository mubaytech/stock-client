...
], IoniconBonfireComponent);
export { IoniconBonfireComponent };
let IoniconBonfireModule = class IoniconBonfireModule {
};
IoniconBonfireModule = __decorate([
    NgModule({
        declarations: [IoniconBonfireComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconBonfireModule);
export { IoniconBonfireModule };
//# sourceMappingURL=Ionicon-bonfire.icon.js.map