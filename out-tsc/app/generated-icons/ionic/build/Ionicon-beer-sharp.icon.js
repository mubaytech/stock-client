...
], IoniconBeerSharpComponent);
export { IoniconBeerSharpComponent };
let IoniconBeerSharpModule = class IoniconBeerSharpModule {
};
IoniconBeerSharpModule = __decorate([
    NgModule({
        declarations: [IoniconBeerSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconBeerSharpModule);
export { IoniconBeerSharpModule };
//# sourceMappingURL=Ionicon-beer-sharp.icon.js.map