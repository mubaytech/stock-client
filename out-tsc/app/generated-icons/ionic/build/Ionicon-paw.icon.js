...
export { IoniconPawComponent };
let IoniconPawModule = class IoniconPawModule {
};
IoniconPawModule = __decorate([
    NgModule({
        declarations: [IoniconPawComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconPawModule };
//# sourceMappingURL=Ionicon-paw.icon.js.map