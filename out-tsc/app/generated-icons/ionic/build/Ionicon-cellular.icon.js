...
let IoniconCellularComponent = class IoniconCellularComponent {
};
IoniconCellularComponent = __decorate([
    Component({
...
export { IoniconCellularComponent };
let IoniconCellularModule = class IoniconCellularModule {
};
IoniconCellularModule = __decorate([
    NgModule({
...
], IoniconCellularModule);
export { IoniconCellularModule };
//# sourceMappingURL=Ionicon-cellular.icon.js.map