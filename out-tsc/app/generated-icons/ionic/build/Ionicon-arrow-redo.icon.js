...
let IoniconArrowRedoComponent = class IoniconArrowRedoComponent {
};
IoniconArrowRedoComponent = __decorate([
    Component({
...
export { IoniconArrowRedoComponent };
let IoniconArrowRedoModule = class IoniconArrowRedoModule {
};
IoniconArrowRedoModule = __decorate([
    NgModule({
...
], IoniconArrowRedoModule);
export { IoniconArrowRedoModule };
//# sourceMappingURL=Ionicon-arrow-redo.icon.js.map