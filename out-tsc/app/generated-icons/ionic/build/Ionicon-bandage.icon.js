...
], IoniconBandageComponent);
export { IoniconBandageComponent };
let IoniconBandageModule = class IoniconBandageModule {
};
IoniconBandageModule = __decorate([
    NgModule({
        declarations: [IoniconBandageComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconBandageModule);
export { IoniconBandageModule };
//# sourceMappingURL=Ionicon-bandage.icon.js.map