...
export const IoniconBasketballSharp = {
    name: 'basketball_sharp',
...
let IoniconBasketballSharpComponent = class IoniconBasketballSharpComponent {
};
IoniconBasketballSharpComponent = __decorate([
    Component({
        selector: 'app-ionicon-basketball-sharp',
        template: `
    <div class="app-ionic-icon">
        ${IoniconBasketballSharp.data}
    </div>
    `,
        styles: [`
    :host{
...
], IoniconBasketballSharpComponent);
export { IoniconBasketballSharpComponent };
let IoniconBasketballSharpModule = class IoniconBasketballSharpModule {
};
IoniconBasketballSharpModule = __decorate([
    NgModule({
        declarations: [IoniconBasketballSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconBasketballSharpModule);
export { IoniconBasketballSharpModule };
//# sourceMappingURL=Ionicon-basketball-sharp.icon.js.map