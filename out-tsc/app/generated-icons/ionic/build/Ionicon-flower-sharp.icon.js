...
], IoniconFlowerSharpComponent);
export { IoniconFlowerSharpComponent };
let IoniconFlowerSharpModule = class IoniconFlowerSharpModule {
};
IoniconFlowerSharpModule = __decorate([
    NgModule({
        declarations: [IoniconFlowerSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconFlowerSharpModule);
export { IoniconFlowerSharpModule };
//# sourceMappingURL=Ionicon-flower-sharp.icon.js.map