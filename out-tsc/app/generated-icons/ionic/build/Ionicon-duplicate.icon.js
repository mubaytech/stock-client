...
let IoniconDuplicateComponent = class IoniconDuplicateComponent {
};
IoniconDuplicateComponent = __decorate([
    Component({
...
export { IoniconDuplicateComponent };
let IoniconDuplicateModule = class IoniconDuplicateModule {
};
IoniconDuplicateModule = __decorate([
    NgModule({
...
], IoniconDuplicateModule);
export { IoniconDuplicateModule };
//# sourceMappingURL=Ionicon-duplicate.icon.js.map