...
let IoniconVolumeLowComponent = class IoniconVolumeLowComponent {
};
IoniconVolumeLowComponent = __decorate([
    Component({
...
export { IoniconVolumeLowComponent };
let IoniconVolumeLowModule = class IoniconVolumeLowModule {
};
IoniconVolumeLowModule = __decorate([
    NgModule({
...
], IoniconVolumeLowModule);
export { IoniconVolumeLowModule };
//# sourceMappingURL=Ionicon-volume-low.icon.js.map