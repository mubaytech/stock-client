...
], IoniconBatteryChargingComponent);
export { IoniconBatteryChargingComponent };
let IoniconBatteryChargingModule = class IoniconBatteryChargingModule {
};
IoniconBatteryChargingModule = __decorate([
    NgModule({
        declarations: [IoniconBatteryChargingComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconBatteryChargingModule);
export { IoniconBatteryChargingModule };
//# sourceMappingURL=Ionicon-battery-charging.icon.js.map