...
], IoniconSnowSharpComponent);
export { IoniconSnowSharpComponent };
let IoniconSnowSharpModule = class IoniconSnowSharpModule {
};
IoniconSnowSharpModule = __decorate([
    NgModule({
        declarations: [IoniconSnowSharpComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconSnowSharpModule);
export { IoniconSnowSharpModule };
//# sourceMappingURL=Ionicon-snow-sharp.icon.js.map