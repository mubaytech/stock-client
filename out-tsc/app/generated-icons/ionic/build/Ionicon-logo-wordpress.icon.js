...
], IoniconLogoWordpressComponent);
export { IoniconLogoWordpressComponent };
let IoniconLogoWordpressModule = class IoniconLogoWordpressModule {
};
IoniconLogoWordpressModule = __decorate([
    NgModule({
        declarations: [IoniconLogoWordpressComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconLogoWordpressModule);
export { IoniconLogoWordpressModule };
//# sourceMappingURL=Ionicon-logo-wordpress.icon.js.map