...
let IoniconCloudDoneSharpComponent = class IoniconCloudDoneSharpComponent {
};
IoniconCloudDoneSharpComponent = __decorate([
    Component({
...
export { IoniconCloudDoneSharpComponent };
let IoniconCloudDoneSharpModule = class IoniconCloudDoneSharpModule {
};
IoniconCloudDoneSharpModule = __decorate([
    NgModule({
...
], IoniconCloudDoneSharpModule);
export { IoniconCloudDoneSharpModule };
//# sourceMappingURL=Ionicon-cloud-done-sharp.icon.js.map