...
], IoniconLogoSoundcloudComponent);
export { IoniconLogoSoundcloudComponent };
let IoniconLogoSoundcloudModule = class IoniconLogoSoundcloudModule {
};
IoniconLogoSoundcloudModule = __decorate([
    NgModule({
        declarations: [IoniconLogoSoundcloudComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconLogoSoundcloudModule);
export { IoniconLogoSoundcloudModule };
//# sourceMappingURL=Ionicon-logo-soundcloud.icon.js.map