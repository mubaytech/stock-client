...
], IoniconColorFilterComponent);
export { IoniconColorFilterComponent };
let IoniconColorFilterModule = class IoniconColorFilterModule {
};
IoniconColorFilterModule = __decorate([
    NgModule({
        declarations: [IoniconColorFilterComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
], IoniconColorFilterModule);
export { IoniconColorFilterModule };
//# sourceMappingURL=Ionicon-color-filter.icon.js.map