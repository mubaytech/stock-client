...
], IoniconLayersComponent);
export { IoniconLayersComponent };
let IoniconLayersModule = class IoniconLayersModule {
};
IoniconLayersModule = __decorate([
    NgModule({
        declarations: [IoniconLayersComponent],
        imports: [
            CommonModule
        ],
        exports: [
...
export { IoniconLayersModule };
//# sourceMappingURL=Ionicon-layers.icon.js.map